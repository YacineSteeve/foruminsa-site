...
export default async function HomePage() {
    ...
    return (
        <div className="w-full min-h-screen">
            <section className="relative flex justify-between items-center xl:gap- 2xl:gap-16 w-full h-[calc(100vh-4.75rem)] min-h-max max-xl:py-16">
                <Image
                    src="/entretien1.jpg"
                    alt=""
                    fill
                ...
                <div className="z-10 flex flex-col max-md:items-center gap-20 flex-3/5 md:pl-10 lg:pl-20 xl:pl-40 2xl:pl-60 text-white">
                    <div className="space-y-4 max-md:text-center">
                        <p className="text-2xl md:text-3xl xl:text-4xl">Participez à</p>
                        <h1 className="!text-5xl md:!text-6xl 3xl:!text-7xl normal-case">
                            La plus grande rencontre étudiants-entreprises
                        </h1>
                        <p className="text-2xl md:text-3xl xl:text-4xl">de l'INSA Toulouse</p>
                    </div>
                    <Link
                    ...
                    >
                        <Button
                            size="lg"
                            color="primary"
                            className="text-xl p-6 2xl:text-2xl lg:p-8"
                        >
                            Inscrivez-vous
                        </Button>
                    </Link>
